...
CEE OS Core is the operating environment's central computer, security, orchestration, and filesystem entry point. Its desktop symbol is a black-and-blue ember: the protected kernel and core services at the center of the system. Core projects files, powerhouses, connections, permissions, and system activity without becoming a second authority over any of them.
...
- Powerhouse creation and start/stop controls plus their permission and health states
