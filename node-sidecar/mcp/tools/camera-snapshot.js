...
module.exports = {
  ...
  definition: {
    ...
    function: {
      name: 'camera_snapshot',
      description: 'Capture one current image from the SHELL camera and visually inspect it. Use only when the user explicitly asks to take a picture or asks what the SHELL camera sees.',
      parameters: {
        type: 'object',
        properties: {
          reason: {
